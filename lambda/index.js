...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome, you can say Hello or Help or tell me about your sleep. Which would you like to try?';
...
const FindSleepClinicIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'FindSleepClinicIntent';
    },
    handle(handlerInput) {
